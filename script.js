...
Aku minta maaf aku bukan cowo yg bisa ngertin kamu, ngga paham sama pikiran kamu. Maaf kalau selama 1 bulan ini sering buat kamu sedih, marah ataupun kecewa, maaf selalu ngerepotin kamu, I am so lucky to have you. Jangan bosan sama aku yaa, jangan cape sama aku, tetap sama aku. Pesan ku cuman satu yaitu tetap semangat dan jangan menyerah :-* `;
...
hilang1.addEventListener('click', () => {
  ...
  Swal.fire({
    imageUrl: "stiker.gif",
    imageHeight: 200,
    title: 'Ketik nama kamu di bawah yah',
    ...
    let txt = `Hai sayangku,
${result.value.login} <3, ${pesan}`;
